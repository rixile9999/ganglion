"""DashScope-backed Qwen clients + DSL repair loop.

Three OpenAI-SDK-against-DashScope clients plus shared completer/repair plumbing:
...
Note: `run_dsl_with_repair` and `RepairConfig` will move to
`ganglion/analyzer/repair.py` in Batch 3 (see `docs/tasks/analyzer_repair_policy.md`).
"""
