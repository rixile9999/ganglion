...
so train/inference distributions match (after Batch 2 M1-A lands, the
canonical home for that helper is ``ganglion.lm.prompts._dsl_messages``).
Anything that changes here MUST also change there (or vice versa) — that
is the load-bearing invariant of the whole factory.
"""
