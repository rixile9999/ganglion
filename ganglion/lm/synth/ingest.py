...
Most of the work delegates to
``ganglion.contract.schema_compiler.compile_tool_calling_schema`` which already
understands these shapes; this module only adds source detection and
convenience defaults (catalog name from filename, etc.).
"""
